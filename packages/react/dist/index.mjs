    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          entries.length > 0 && /* @__PURE__ */ jsx("span", { style: { background: "rgba(99,102,241,0.2)", color: "#a78bfa", border: "1px solid rgba(167,139,250,0.3)", borderRadius: 9999, padding: "2px 8px", fontSize: 11, fontWeight: 600 }, children: entries.length })
        ]
      }
    )
  ] });
...
function PanelContent({ colors, entries, selected, setSelected, sel, onClear, onClose, client, isRequesting, setIsRequesting }) {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { style: { background: `linear-gradient(135deg, ${colors.bg2} 0%, ${colors.bg3} 100%)`, borderBottom: `1px solid ${colors.border}`, padding: "14px 16px", display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }, children: [
      /* @__PURE__ */ jsx("span", { style: { fontSize: 14, fontWeight: 700, letterSpacing: "-0.5px", background: "linear-gradient(135deg, #60a5fa, #a78bfa)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }, children: "\u{1F6E1}\uFE0F Ciph" }),
      /* @__PURE__ */ jsxs("span", { style: { fontSize: 11, background: colors.bg3, border: `1px solid ${colors.border}`, borderRadius: 10, padding: "3px 8px", color: colors.text2, fontWeight: 500 }, children: [
        entries.length,
        " ",
        entries.length === 1 ? "request" : "requests"
      ] }),
      /* @__PURE__ */ jsx("span", { style: { fontSize: 10, color: colors.text2, background: "rgba(99,102,241,0.1)", border: `1px solid ${colors.border}`, borderRadius: 6, padding: "3px 7px", fontWeight: 500 }, children: "client" }),
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", flex: 1, overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { width: "480px", borderRight: `1px solid ${colors.border}`, overflowY: "auto", flexShrink: 0 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { position: "sticky", top: 0, background: colors.bg2, borderBottom: `1px solid ${colors.border}`, padding: "8px 14px", display: "flex", alignItems: "center", gap: "12px", color: colors.text2, fontSize: "10px", textTransform: "uppercase", letterSpacing: "0.5px", fontWeight: 600 }, children: [
          /* @__PURE__ */ jsx("span", { style: { minWidth: "60px" }, children: "Method" }),
          /* @__PURE__ */ jsx("span", { style: { flex: 1, minWidth: "200px" }, children: "Route" }),
          /* @__PURE__ */ jsx("span", { style: { minWidth: "50px", textAlign: "center" }, children: "Status" }),
          /* @__PURE__ */ jsx("span", { style: { minWidth: "50px", textAlign: "right" }, children: "Time" })
        ] }),
        entries.length === 0 && /* @__PURE__ */ jsxs("div", { style: { padding: 24, color: colors.text2, fontSize: 13, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsx("div", { style: { opacity: 0.5, fontSize: 24 }, children: "\u25CB" }),
          /* @__PURE__ */ jsxs("div", { children: [
            "No requests yet.",
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { style: { fontSize: 11, color: colors.text2, opacity: 0.7 }, children: "Make an API call to see logs" })
          ] })
        ] }),
        entries.map((e, i) => {
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { style: { fontSize: 10, fontWeight: 700, padding: "3px 6px", borderRadius: 6, background: mc.bg, color: mc.text, textAlign: "center", minWidth: 60 }, children: e.log.method }),
                /* @__PURE__ */ jsx("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: colors.text, fontSize: 12, flex: 1, minWidth: 200 }, children: e.log.route }),
                /* @__PURE__ */ jsx("span", { style: { color: statusColor(e.log.status), fontWeight: 600, fontSize: 12, textAlign: "center", minWidth: 50 }, children: e.log.status || "\u2026" }),
                /* @__PURE__ */ jsxs("span", { style: { color: colors.text2, fontSize: 12, textAlign: "right", minWidth: 50 }, children: [
                  e.log.duration,
                  "ms"
                ] })
              ]
