...
function DevtoolsPanel({ maxLogs = 500, defaultOpen = false, position = "bottom-right" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: positionStyle(position), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          "\u{1F6E1}\uFE0F Ciph",
          entries.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { background: "#58a6ff22", color: "#58a6ff", border: "1px solid #58a6ff44", borderRadius: 10, padding: "1px 6px", fontSize: 10 }, children: entries.length })
        ]
      }
    )
  ] });
...
function CiphProvider({ children, devtools: devtoolsConfig, ...config }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(CiphContext.Provider, { value: client, children: [
    children,
    devtoolsEnabled && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CiphDevtoolsPanel, { ...panelProps })
  ] });
}
function useCiph() {
