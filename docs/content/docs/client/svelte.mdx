---
title: "Svelte"
description: "Ciph client integration for Svelte applications (Coming Soon)"
---

# Svelte (Coming Soon)

Svelte support for `@ciph/react` is coming in a future release.

For now, you can:
- Use `@ciph/react` directly in Svelte (axios-compatible)
